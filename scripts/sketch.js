...
function customWave() {
  ...
  } else if (dificuldadeJogo == 4) {
    if (wave == 0) {
      tempWave.push(["fracoE", 5]); // 5
    } else if (wave == 1) {
      tempWave.push(["fracoE", 7]); // 6
    } else if (wave == 2) {
      tempWave.push(["fracoE", 8]); //12
    } else if (wave == 3) {
      tempWave.push(["fracoE", 7], ["normalE", 5]); //14
    } else if (wave == 4) {
      tempWave.push(["fracoE", 8], ["normalE", 6]); //16
    } else if (wave == 5) {
      tempWave.push(["fracoE", 9], ["normalE", 7]); //18
    } else if (wave == 6) {
      tempWave.push(["fracoE", 10], ["normalE", 8], ["forteE", 5]); //25
    } else if (wave == 7) {
      tempWave.push(["fracoE", 11], ["normalE", 9], ["forteE", 6]); //28
    } else if (wave == 8) {
      tempWave.push(["fracoE", 12], ["normalE", 10], ["forteE", 7]); //31
    } else if (wave == 9) {
      tempWave.push(["fracoE", 13], ["normalE", 11], ["forteE", 8]); //34
    } else if (wave == 10) {
      tempWave.push(["fracoE", 14], ["normalE", 12], ["forteE", 9]); //37
    }
  }
